    ...
    return (function(t) {
            ...
            W ||
                (a(
                    (M = function() {
                        ...
                        return (
                            r && G && K(V, t, { configurable: !0, set: e }),
                            U(t)
                        );
                    }).prototype,
                    "toString",
        ...
        function(t, e, n) {
            for (
                ...
                if (
                    w &&
                    (w[l] || a(w, l, f), w[h] || a(w, h, g), (c[g] = f), m)
                )
                    ...
                    ("__proto__" in {}
                        ? (function(t, e, o) {
                              try {
                                  (o = n(22)(
                                      Function.call,
                                      n(49).f(Object.prototype, "__proto__")
                                          .set,
                                      2
                                  ))(t, []),
                                ...
                                t || ((t = p(l)), document.body.appendChild(t)),
                                    ...
                                    this.options.animate ||
                                        (this.node.parentElement &&
                                            this.node.parentElement.removeChild(
                                                this.node
                                            ));
                            }
                        },
                    ...
                    (n = [
                        ...
                        },
                        {
                            ...
                            value: function() {
                                ...
                                return (
                                    -1 ===
                                    ["absolute", "fixed", "relative"].indexOf(t)
                                );
                            }
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function(t) {
                                ...
                                (this.node.style.display = "block"),
                                    ...
                                    (this.node.style.width = "".concat(
                                        n,
                                        "px"
                                    )),
                                    (this.node.style.height = "".concat(
                                        o,
                                        "px"
                                    )),
                                    (this.node.style.top = "".concat(
                    ...
                    (n = [
                        ...
                        },
                        {
                            ...
                            value: function() {
                                ...
                                t &&
                                    ...
                                    t.options.onNext &&
                                    t.options.onNext(
                                        this.overlay.highlightedElement
                                    ),
                                    this.currentMovePrevented ||
                                        this.moveNext();
                            }
                        },
                        {
                        ...
                        },
                        {
                            ...
                            value: function(t) {
                                ...
                                for (var e = 0; e < t.length; e++) {
                                    var n = this.prepareElementFromStep(
                                        t[e],
                                        t,
                                        e
                                    );
                        ...
                        },
                        {
                            ...
                            value: function(t) {
                                ...
                                var s = v(i)
                                    ? i
                                    : this.document.querySelector(i);
                                if (!s)
                                    return (
                                        console.warn(
                                            "Element to highlight ".concat(
                                                i,
                                                " not found"
                                            )
                                        ),
