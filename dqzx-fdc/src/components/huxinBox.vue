<template>
    <div class="huxinbox">
        ...
        <div style="margin-top: 0.19rem">
            <label class="name9" style="float:left">{{name}}</label>
            <label style="margin-left: 0.19rem;margin-top: 0.19rem;" class="status0" v-if="status == 1">待售</label>
...
<script>
    ...
    export default {
        name: "huxinBox",
        props:["img","name","type","status","area","id"],
        components:{
            ImagePreview
        },
        methods: {
